...
namespace Yuzuri.Helpers
{
    ...
    {
        public static DiscordButtonComponent MainHand => new DiscordButtonComponent(ButtonStyle.Secondary, "MainHand", "Weapons", false, new DiscordComponentEmoji(EmojiHelper.GetItemEmoji(ItemCategory.MainHand)));
